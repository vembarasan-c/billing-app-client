...
const AdminForm = ({onAdd, selectedAdmin, onUpdateUser}) => {
    ...
    // when selectedAdmin changes, populate or clear the form
    useEffect(() => {
        if (selectedAdmin && selectedAdmin.userId) {
            setData({
                name: selectedAdmin.name || '',
                email: selectedAdmin.email || '',
                password: '',
                role: selectedAdmin.role || 'ROLE_ADMIN',
                userId: selectedAdmin.userId
            });
        } else if (!selectedAdmin) {
            setData({ name: '', email: '', password: '', role: 'ROLE_ADMIN' });
        }
    }, [selectedAdmin]);
